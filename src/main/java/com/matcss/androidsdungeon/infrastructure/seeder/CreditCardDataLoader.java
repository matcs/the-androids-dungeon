...
public class CreditCardDataLoader implements ApplicationRunner {
    ...
    private List<CreditCard> generateCreditCardList(){
        ...
        return Arrays.asList(
                new CreditCard("5477884614340222","218","16/10/2022",true, new Customer(1)),
                new CreditCard("5480976880175475","957","16/10/2021",false, new Customer(1)),
                new CreditCard("5169228949657087","413","16/10/2022",false, new Customer(2))
        );
    }
}
